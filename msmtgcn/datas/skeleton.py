...
class SkeletonDataset(Dataset):
    ...
    def get_val_repeat(self, idx):
        ...
        return [repeat_data, repeat_confidence, label]
    ...
    def __getitem__(self, idx):
        if self.mode == "train":
            ...
            result = self.get_test_repeat(idx)
        elif self.mode == "val_repeat":
            result = self.get_val_repeat(idx)
        elif self.mode == "val_single":
            result = self.get_train(idx)
        return result
